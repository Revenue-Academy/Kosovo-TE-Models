  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Indirect Taxes", icon = icon("shopping-cart"),
               menuSubItem("Customs Taxes Module", tabName = "customsModule", icon = icon("truck")),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(
        ...
        h3("Customs Taxes Module"),
        p("The Customs Taxes Module provides simulations,analysis for customs policies and estimation of tax expenditures."),
        br(),
