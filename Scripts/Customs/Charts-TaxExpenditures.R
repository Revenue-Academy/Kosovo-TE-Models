...
Tax_Expenditures_Charts <- function(ProjectionTE,CustomsDuties_TE_Sections,CustomsDuties_TE_MTN,CustomsDuties_TE_agg_countries_tbl,
  ...
  # Chart 2. Tax expenditures by HS Sections -----------------------------------------------------------------
  ...
  # Chart 3. Tax expenditures by Top 15 Importing Countries -------------------------------------------------------------------------
