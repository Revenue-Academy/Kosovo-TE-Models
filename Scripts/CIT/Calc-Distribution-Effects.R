...
# DO OVDE STIGNATO 19/03/2025 dA se prodolzi nadole so voveduvanje na estimacija za small corporation a potoa da se napravi poseben dashboard za niv
# Chart-Distribution_Small.R                            
                        
                        
#  Distribution Table Income Breaks -----------------------------------------------------------
...
# SMALL CORPORATIONS ------------------------------------------------------
                              ...
                              # Define the breakpoints and labels  #12 #11
                              # breaks <- c(-Inf, 0, 1, 0.5e6, 1e6, 1.5e6, 2e6, 3e6, 4e6, 5e6, 10e6, Inf)
                              # labels <- c("<0", "0", "0-0.5m", "0.5-1m", "1-1.5m", "1.5-2m", "2-3m", "3-4m", "4-5m", "5-10m", ">10m")
                              
                              # breaks <- c(-Inf, 0, 10000, 50000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, Inf)
                              ...
                              # breaks <- c(-Inf, 0, 10000, 50000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, Inf) #13 #13
                              # labels <- c("<0", "=0", "0-10000", "10000-50000", "50000-100000", "100000-200000", "200000-300000", "300000-400000", "400000-500000", "500000-600000", "600000-700000", "700000-800000")
                              
                              
                              # breaks <- c( 0, 1000, 50000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, Inf) #13 #13
                              # labels <- c("=0","0-1000", "10000-50000", "50000-100000", "100000-200000", "200000-300000", "300000-400000", "400000-500000", "500000-600000", "600000-700000", "700000-800000")
                              # 
