...
# I. Labor-capital -----------------------------------------------------
                  ...
                  # Select columns 
                  selected_gross_desc_tbl <- select(CIT_BU_list$t0, all_of(columns_gross_income))
...
# II. Type of Income ---------------------------------------------------------------------
                        ...
                        gross_income_BU_SIM<-merged_CIT_BU_SIM%>%
...
selected_gross_nace_tbl <- select(CIT_BU_list$t0, all_of(columns_gross_nace_income))
